...
defaultInlines.for = (text) => `<foreign>${text}</foreign>`;
defaultInlines.lit = (text) => `<literal>${text}</literal>`;
defaultInlines.id = (text) => `<id>${text}</id>`;
defaultInlines.q = (text) => `<quote>\u201C${text}\u201D</quote>`;
defaultInlines.d = (text) => `<deleted>${text}</deleted>`;
